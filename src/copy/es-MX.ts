...
export const copy = {
  ...
  network: {
    ...
    directoryTitle: 'Personas que construyen FIRMA23',
  ...
  progression: {
    title: 'Progresión operativa',
    verifiedOutcomes: 'Outcomes verificados',
    level: 'LVL',
    xp: 'XP',
    toNextLevel: 'XP al siguiente nivel',
    maxLevel: 'Nivel máximo de esta temporada',
    ruleset: 'Reglas',
    disclaimer: 'Sólo cuenta cierres y entregas verificadas. No usa dinero, commits, tokens ni horas.',
  },
  leaderboard: {
    title: 'Ranking',
