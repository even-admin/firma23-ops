...
export const copy = {
  ...
  settle: {
    ...
    approving: 'Aprobando liquidación…',
    approved: 'Liquidación aprobada. Actualizando los montos confirmados.',
    approvalReady: 'La liquidación se calculará desde el efectivo confirmado y la regla vigente.',
    approvalNotReady: 'Completa las verificaciones antes de aprobar la liquidación.',
    error: 'No pudimos aprobar la liquidación. Reintenta cuando el servicio responda.',
